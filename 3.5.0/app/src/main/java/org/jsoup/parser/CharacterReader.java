...
public final class CharacterReader {
    ...
    public static final int minReadAheadLen = 1024; // the minimum mark length supported. No HTML entities can be larger than this.
    ...
    public String[] stringCache = new String[stringCacheSize]; // holds reused strings in this doc, to lessen garbage
    ...
    public boolean readFully; // if the underlying stream has been completely read, no value in further buffering
    ...
    public boolean isEmptyNoBufferUp() {
        return bufPos >= bufLength;
    }
