...
public class DownloaderNew {
    ...
    public static DownloaderNew getInstance(Context mContext) {
        return (new DownloaderNew(mContext));
    }
    ...
    public DownloaderNew setToken(String token) {
        mToken = token;
        return this;
    }

    public DownloaderNew setListener(DownloadListener listener) {
        mListener = listener;
        return this;
    }

    public DownloaderNew setUrl(String url) {
        mUrl = url;
        if (isIdEmpty(mToken)) {
            mToken = mUrl;
        }
    ...
    public DownloaderNew setNotificationTitle(String title) {
        mTitle = title;
        return this;
    }


    public DownloaderNew setDescription(String description) {
        mDescription = description;
        return this;
    }

    public DownloaderNew setScanningByMediaScanner(Boolean scanningByMediaAllowed) {
     ...
     */
    @Deprecated()
    public DownloaderNew setCustomDestinationDir(String destinationDir, String fileName) {
    ...
    public DownloaderNew setDestinationDir(@Storage.DownloadDirectory String destinationDir, String fileName) {
        mDestinationDir = destinationDir;
        mFileName = fileName;
        return this;
    }
    ...
    public DownloaderNew setNotificationVisibility(int visibility) {
        mNotificationVisibility = visibility;
        return this;
    }

    public DownloaderNew setAllowedNetworkTypes(int networkTypes) {
        mNetworkTypes = networkTypes;
        return this;
    }

    public DownloaderNew setAllowedOverRoaming(boolean allowed) {
        mRoamingAllowed = allowed;
        return this;
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public DownloaderNew setAllowedOverMetered(boolean allowed) {
        mMeteredAllowed = allowed;
        return this;
    }

    public DownloaderNew setVisibleInDownloadsUi(boolean isVisible) {
    ...
    private void startDownload() {
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(mUrl.replace("\"", "")));
    ...
    public static DownloadItem getDownloadItem(Context context, String token) {
        ...
        long downloadId = DownloaderNew.getDownloadId(context, token);
        if (downloadId < 0)
            return null;
        DownloadManager.Query q = new DownloadManager.Query();
        q.setFilterById(downloadId);
    ...
    private static DownloadItem fetchDownloadItem(Context context, Cursor cursor) {
        ...
        downloadItem.setToken(DownloaderNew.getToken(context, downloadItem.getDownloadId()));
    ...
    public DownloaderNew setKeptAllDownload(boolean allDownloadKept) {
